export default {
  ...
  ui: {
    ...
    homeEyebrow: '{count} biais · six langues',
    homeTitle: 'Prenez votre esprit — et votre machine — la main dans le sac.',
    homeLead: 'Les biais sautent aux yeux chez les autres et restent presque invisibles chez soi. Partez de ce que vous faites, et voyez lesquels rôdent.',
    homeBrowse: 'Voir les {count}',
    situationsTitle: 'Que faites-vous en ce moment ?',
    situationsLead: 'Choisissez un moment. Voici les biais les plus susceptibles d’être dans la pièce.',
    situationsAll: 'Tous les biais de ce domaine',
    sitMoney: 'Dépenser ou investir',
    sitMoneyHint: 'Un prix, une promo, un pari qu’on n’arrive pas à lâcher.',
    sitJudging: 'Juger quelqu’un',
    sitJudgingHint: 'Un collègue, un inconnu, un candidat en face de vous.',
    sitArguing: 'Débattre de l’actualité',
    sitArguingHint: 'Quand vous avez raison et qu’ils ne le voient simplement pas.',
    sitLearning: 'Apprendre quelque chose',
    sitLearningHint: 'Le premier article, le premier cours, le premier « j’ai compris ».',
    sitRemembering: 'Se souvenir',
    sitRememberingHint: 'L’histoire que vous racontez sur la façon dont c’est arrivé.',
    sitAi: 'Travailler avec l’IA',
    sitAiHint: 'Demander, faire confiance, déléguer — et les habitudes du modèle lui-même.',
    dailyTitle: 'Biais du jour',
    dailyLead: 'Aujourd’hui, c’est le même pour tout le monde. Essayez de le repérer avant ce soir.',
    readMore: 'Lire la suite',
    twinsTitle: 'Vous et la machine',
    twinsLead: 'Les modèles ont appris de nous et ont hérité de nos habitudes. Chaque biais de l’ère de l’IA fait écho à un biais humain plus ancien.',
    twinsHuman: 'L’original humain',
    twinsMachine: 'Son écho à l’ère de l’IA',
    quizBlockTitle: 'Lesquels sont les vôtres ?',
    quizBlockLead: 'Huit situations rapides, pas de bonne réponse, environ deux minutes. Choisissez une série.',
    backToAll: 'Tous les biais',
    relatedTitle: 'Souvent dans la même pièce',
    echo: 'Écho à l’ère de l’IA',
    pagerLabel: 'Autres biais',
    previous: 'Précédent',
    next: 'Suivant',
    notFoundTitle: 'Aucun biais de ce nom',
    notFoundHint: 'Il a peut-être été renommé. Le dictionnaire les contient tous.',
    promptLabel: 'À coller dans le chat',
    copy: 'Copier',
    copied: 'Copié',
    promptsTitle: 'Garder la machine honnête',
    promptsLead: 'Des consignes à coller avant de faire confiance à une réponse. Chaque biais de l’ère de l’IA a la sienne ; voici les trois qui serviront le plus.',
    promptsAll: 'Les douze biais de l’ère de l’IA',
    mapHuman: 'L’esprit humain',
    mapMachine: 'L’ère de l’IA',
    mapHint: 'Faites glisser pour tourner · touchez un point pour l’ouvrir',
    navPlay: 'Jouer',
    share: 'Partager',
    shareCopied: 'Lien copié',
    shareImage: 'Enregistrer l’image',
    shareBroken: 'Ce lien partagé est incomplet.',
    shareReceived: 'Quelqu’un vous a partagé ceci',
    shareGameLead: 'biais cognitifs repérés dans dix moments du quotidien.',
    shareBeat: 'Ferez-vous mieux ?',
    shareFindYours: 'Trouver les vôtres',
    shareGameText: 'Mon score : {score} sur {total} biais cognitifs. Ferez-vous mieux ?',
    shareGameLine: 'biais cognitifs repérés. Ferez-vous mieux ?',
    shareQuizText: 'Mes angles morts : {names}. Et les vôtres ?',
    shareQuizNone: 'À l’auto-test, j’ai esquivé les {total} biais. Vraiment ?',
    shareTheirs: 'Leurs angles morts',
    shareTheirsNone: 'Aucun, paraît-il. Ce qui en dit long sur l’angle mort des biais.',
    openApp: 'Explorer en interactif',
  },
  ...
  demos: {
    scenes: {
      legend: {
        ...
        oneView: 'Un avis',
        otherView: 'L’autre',
        holes: 'Impacts de balles',
        lost: 'Jamais revenus',
        anchor: 'Nombre montré d’abord',
        truth: 'Longueur réelle',
        mean: 'Estimation moyenne',
      },
      title: 'Comment ça marche',
      simulated: 'Simulation',
      play: 'Lancer',
      intro: 'Regardez la scène se dérouler.',
      modelCollapse: {
        gen: 'Génération {n} : chaque modèle n’apprend que de ce qu’a écrit le précédent. La courbe grise marque le point de départ.',
        end: 'Le rare et l’étrange ont disparu. Il ne reste que la moyenne.',
      },
      feedback: {
        start: 'Les gens penchent légèrement d’un côté : {share} %.',
        model: 'Passage {n} : le modèle accentue la tendance — {share} %.',
        people: 'Passage {n} : les gens absorbent la version accentuée et la renvoient — {share} %.',
      },
      survivorship: {
        returned: 'Impacts de balles sur les bombardiers revenus. Premier réflexe : blinder ces zones.',
        lost: 'Mais les avions touchés ici ne sont jamais revenus. Le blindage va là où il n’y a pas de trous.',
      },
      anchoring: {
        round: 'Après avoir vu {anchor} km, les gens estiment en moyenne {mean} km. La longueur réelle est de {truth} km.',
      },
    },
    kicker: 'Avant de lire quoi que ce soit, essayez',
    another: 'Autre expérience',
    readAbout: 'En savoir plus : {name}',
    show: 'Voir',
    anchoring: {
      q1: 'Le Nil est-il plus long ou plus court que {anchor} km ?',
      longer: 'Plus long',
      shorter: 'Plus court',
      q2: 'Maintenant, votre meilleure estimation : quelle est la longueur du Nil ?',
      unit: 'km',
      reveal: 'Le Nil mesure environ {truth} km. Votre réponse : {guess}.',
      markAnchor: 'Notre nombre',
      markTruth: 'Longueur réelle',
      markYou: 'Vous',
      explain: 'Le {anchor} de la première question a été tiré au sort : la moitié des visiteurs voit {low}, l’autre moitié {high}. Il attire pourtant les réponses : dans les expériences, ceux à qui l’on montre le nombre le plus élevé donnent des estimations nettement plus hautes, même en sachant qu’il ne veut rien dire.',
    },
    framing: {
      setup: 'Une nouvelle maladie devrait toucher 600 personnes. Vous devez choisir entre deux programmes. Lequel ?',
      gainA: 'Programme A : 200 personnes seront sauvées.',
      gainB: 'Programme B : une chance sur trois de sauver les 600, et deux chances sur trois de ne sauver personne.',
      lossA: 'Programme A : 400 personnes mourront.',
      lossB: 'Programme B : une chance sur trois que personne ne meure, et deux chances sur trois que les 600 meurent.',
      youSure: 'Vous avez choisi la certitude.',
      youGamble: 'Vous avez choisi le pari.',
      reveal: 'D’autres visiteurs ont vu le même choix formulé ainsi :',
      explain: 'Les deux versions décrivent exactement les mêmes issues. Dans l’étude d’origine, 72 % choisissaient l’option sûre quand on parlait de vies sauvées, et seulement 22 % quand on parlait de morts (Tversky et Kahneman, 1981).',
    },
    forer: {
      q: 'Choisissez votre mois de naissance, et nous décrirons votre personnalité.',
      reading: [
        'Vous avez fortement besoin que les autres vous apprécient et vous respectent.',
        'Vous avez tendance à vous juger sévèrement.',
        'Vous avez beaucoup de capacités que vous n’avez pas encore exploitées.',
        'Il vous arrive de douter sérieusement d’avoir pris la bonne décision.',
        'Vous pensez par vous-même et n’acceptez pas les affirmations des autres sans preuve.',
      ],
      rate: 'À quel point cela vous décrit-il ?',
      low: 'Pas du tout',
      high: 'Tout à fait',
      reveal: 'Vous lui avez donné {rating} sur 5. Tout le monde reçoit exactement ce texte, quel que soit le mois choisi.',
      explain: 'En 1949, le psychologue Bertram Forer a remis à ses étudiants un profil « personnel » tiré d’un livre d’horoscopes. Tous ont reçu le même, et lui ont attribué en moyenne une précision de 4,3 sur 5.',
    },
  },

  game: {
    eyebrow: 'Un jeu · {count} manches',
    title: 'Repérez le biais',
    lead: 'Dix moments du quotidien. Nommez le biais caché dans chacun, puis voyez quoi en faire.',
    start: 'Commencer',
    progress: 'Manche {n} sur {total}',
    score: '{score} / {total}',
    question: 'De quel biais s’agit-il ?',
    right: 'Exact.',
    wrong: 'Pas tout à fait : c’est {name}.',
    next: 'Suivant',
    finish: 'Voir le résultat',
    resultEyebrow: 'Votre score',
    verdict10: 'Tous sans exception. Essayez maintenant de les repérer en vous-même : c’est le plus dur.',
    verdict8: 'L’œil vif. Ceux qui vous ont échappé sont ci-dessous.',
    verdict5: 'Pas mal. Les biais sont plus faciles à nommer sur le papier que sur le moment.',
    verdict0: 'Ils sont glissants. Relisez ceux qui vous ont échappé, puis rejouez.',
    missedTitle: 'À revoir',
    again: 'Rejouer',
  },
  ...
  biases: {
    'fundamental-attribution-error': {
      ...
      counter: 'Avant d’accuser le caractère de quelqu’un, trouvez un élément de sa situation qui pourrait l’expliquer, comme vous le feriez pour vous-même.',
    },
    'self-serving-bias': {
      ...
      counter: 'Pour votre dernier succès, notez ce qui vous a aidé ; pour votre dernier échec, notez ce que vous auriez pu faire autrement.',
    },
    'in-group-favoritism': {
      ...
      counter: 'Imaginez la même demande venant de quelqu’un d’extérieur à votre groupe. Si votre réponse change, c’est le groupe qui décide, pas vous.',
    },
    'bandwagon-effect': {
      name: 'Effet de mode',
      ...
      counter: 'Demandez-vous ce que vous penseriez de l’idée si personne ne l’avait encore adoptée.',
    },
    groupthink: {
      ...
      counter: 'Chargez une personne de contester le plan, et sollicitez les objections avant la décision, pas après.',
    },
    'halo-effect': {
      name: 'Effet de halo',
      description:
      ...
      counter: 'Jugez chaque qualité séparément : évaluez le travail avant de rencontrer la personne, ou la personne avant de voir son CV.',
    },
    'moral-luck': {
      name: 'Chance morale',
      description:
      ...
      counter: 'Jugez la décision d’après ce que l’on savait au moment de la prendre, pas d’après la façon dont les choses ont tourné.',
    },
    'false-consensus': {
      name: 'Faux consensus',
      description: 'Nous croyons que davantage de gens partagent notre avis qu’en réalité.',
      example: '« Tout le monde pense ça ! »',
      counter: 'Avant de supposer que les gens sont d’accord avec vous, posez la question à quelques-uns, surtout à ceux qui ne vous ressemblent pas.',
    },
    'curse-of-knowledge': {
      ...
      counter: 'Expliquez-le à un novice et observez où il décroche : c’est là que votre explication doit commencer.',
    },
    'spotlight-effect': {
      ...
      counter: 'Rappelez-vous le peu de choses que vous avez remarquées chez les autres à la dernière réunion. Ils en remarquent à peu près autant chez vous.',
    },
    'availability-heuristic': {
      ...
      counter: 'Quand quelque chose vous paraît probable, cherchez sa fréquence réelle plutôt que l’exemple le plus frappant.',
    },
    'defensive-attribution': {
      ...
      counter: 'Remarquez si vous blâmez moins quelqu’un parce qu’il vous ressemble. Appliquez le même critère à quelqu’un qui ne vous ressemble pas.',
    },
    'just-world-hypothesis': {
      ...
      counter: 'Quand le malheur frappe quelqu’un, demandez-vous ce qui devrait être vrai pour que ce soit de la malchance, puis vérifiez.',
    },
    'naive-realism': {
      name: 'Réalisme naïf',
      description:
      ...
      counter: 'Partez du principe que l’autre camp voit quelque chose qui vous échappe, et formulez son point de vue assez bien pour qu’il approuve votre résumé.',
    },
    'naive-cynicism': {
      name: 'Cynisme naïf',
      description:
      ...
      counter: 'Avant de soupçonner un motif égoïste, trouvez une raison généreuse qui aurait pu mener au même comportement.',
    },
    'forer-effect': {
      ...
      counter: 'Demandez-vous si la description s’appliquerait à la plupart des gens que vous connaissez. Si oui, elle ne dit rien de vous.',
    },
    'dunning-kruger-effect': {
      ...
      counter: 'Avant d’avoir une certitude, demandez-vous quelle question un expert du domaine poserait ensuite, et si vous sauriez y répondre.',
    },
    anchoring: {
      name: 'Ancrage',
      ...
      counter: 'Faites votre propre estimation avant de regarder le premier chiffre, ou envisagez délibérément un point de départ très différent.',
    },
    'automation-bias': {
      ...
      counter: 'Décidez à l’avance quels résultats vous vérifierez à la main, et vérifiez-les même si le système ne se trompe pas depuis des semaines.',
    },
    'google-effect': {
      ...
      counter: 'Si vous en aurez besoin sans connexion, ou pour juger une réponse, prenez le temps de l’apprendre, pas seulement de le chercher.',
    },
    reactance: {
      name: 'Réactance',
      description:
      ...
      counter: 'Quand vous avez envie de faire l’inverse, demandez-vous si vous le choisiriez si personne ne vous avait rien dit.',
    },
    'confirmation-bias': {
      ...
      counter: 'Cherchez les meilleurs arguments contre ce que vous croyez, et décidez d’avance ce qui vous ferait changer d’avis.',
    },
    'backfire-effect': {
      ...
      counter: 'Quand une correction vous pique, distinguez « c’est désagréable » de « c’est faux » avant de répondre.',
    },
    'third-person-effect': {
      ...
      counter: 'Partez du principe que les pubs, les titres et les fils d’actualité qui influencent les autres vous influencent aussi, et vérifiez d’où vient votre dernière opinion.',
    },
    'belief-bias': {
      ...
      counter: 'Testez le raisonnement avec une conclusion qui vous déplaît. Si la même logique vous convaincrait là aussi, c’est bien la logique que vous jugez.',
    },
    'availability-cascade': {
      ...
      counter: 'Comptez les sources indépendantes, pas le nombre de fois où vous l’avez entendu.',
    },
    declinism: {
      name: 'Déclinisme',
      description:
      ...
      counter: 'Comparez le passé à partir de données plutôt que de souvenirs : la nostalgie efface les mauvais jours.',
    },
    'status-quo-bias': {
      ...
      counter: 'Imaginez que vous partiez de zéro aujourd’hui. Choisiriez-vous ce que vous avez maintenant ?',
    },
    'sunk-cost-fallacy': {
      ...
      counter: 'Demandez-vous seulement : sachant ce que je sais maintenant, est-ce que je me lancerais aujourd’hui ? Ce qui est dépensé l’est de toute façon.',
    },
    'gamblers-fallacy': {
      ...
      counter: 'Rappelez-vous que les dés, les pièces et les roulettes n’ont pas de mémoire. Chaque essai repart de zéro.',
    },
    'zero-risk-bias': {
      ...
      counter: 'Comparez la part du risque total que chaque option supprime, pas celle qui fait disparaître un seul risque.',
    },
    'framing-effect': {
      ...
      counter: 'Reformulez le choix dans l’autre sens (pertes en gains, pourcentages en nombres) et voyez si votre réponse tient.',
    },
    stereotyping: {
      name: 'Stéréotypage',
      description:
      ...
      counter: 'Demandez-vous ce que vous savez réellement de cette personne, et non ce que vous supposez de son groupe.',
    },
    'outgroup-homogeneity-bias': {
      ...
      counter: 'Citez trois façons dont les membres de l’autre groupe diffèrent les uns des autres.',
    },
    'authority-bias': {
      ...
      counter: 'Demandez-vous si l’affirmation vous convaincrait sans le titre de son auteur, et si l’expert parle bien de son domaine.',
    },
    'placebo-effect': {
      name: 'Effet placebo',
      ...
      counter: 'Pour juger si quelque chose marche, cherchez des comparaisons avec un placebo, pas seulement des témoignages de gens qui se sont sentis mieux.',
    },
    'survivorship-bias': {
      ...
      counter: 'Demandez où sont les échecs. Pour chaque réussite, cherchez ceux qui ont fait la même chose sans y arriver.',
    },
    tachypsychia: {
      name: 'Tachypsychie',
      ...
      counter: 'Après un événement stressant, notez vite la chronologie et vérifiez-la avec des horloges, des journaux ou des témoins avant de vous y fier.',
    },
    'law-of-triviality': {
      ...
      counter: 'Accordez à chaque point un temps proportionnel à l’enjeu, et placez le plus difficile en tête de l’ordre du jour.',
    },
    'zeigarnik-effect': {
      ...
      counter: 'Notez les tâches inachevées avec une prochaine étape, pour que votre esprit cesse de les ressasser.',
    },
    'ikea-effect': {
      name: 'Effet IKEA',
      ...
      counter: 'Faites juger votre travail par quelqu’un qui n’y a pas participé, et comparez-le à ce que vous auriez pu acheter ou emprunter.',
    },
    'ben-franklin-effect': {
      ...
      counter: 'Remarquez si vous appréciez quelqu’un parce que vous l’avez aidé. Servez-vous-en avec bienveillance : demander un petit service crée des liens.',
    },
    'bystander-effect': {
      ...
      counter: 'Quand quelque chose ne va pas, partez du principe que personne n’a agi. Si vous avez besoin d’aide, désignez une personne et adressez-vous à elle.',
    },
    suggestibility: {
      name: 'Suggestibilité',
      description:
      ...
      counter: 'Posez des questions ouvertes, « que s’est-il passé ? », plutôt que des questions qui contiennent la réponse, et méfiez-vous des détails apportés par la question.',
    },
    'false-memory': {
      name: 'Faux souvenir',
      ...
      counter: 'Traitez les souvenirs les plus nets comme des affirmations à vérifier. Cherchez des notes, des photos ou des messages de l’époque.',
    },
    cryptomnesia: {
      name: 'Cryptomnésie',
      ...
      counter: 'Avant de présenter une idée comme originale, faites une recherche, et notez d’où viennent vos idées.',
    },
    'clustering-illusion': {
      ...
      counter: 'Avant de vous fier à un motif, demandez-vous à quelle fréquence le hasard seul produirait quelque chose d’approchant.',
    },
    'pessimism-bias': {
      ...
      counter: 'Notez le résultat probable, pas seulement le pire, et vérifiez plus tard combien de fois le pire s’est vraiment produit.',
    },
    'optimism-bias': {
      ...
      counter: 'Planifiez d’après la durée réelle de projets similaires, pas d’après la durée que celui-ci devrait prendre selon votre impression.',
    },
    'blind-spot-bias': {
      ...
      counter: 'Partez du principe que vous avez les biais que vous voyez chez les autres. Demandez à une personne de confiance de vous en signaler un.',
    },
    ...
    'algorithm-aversion': {
      ...
      counter: 'Comparez le taux d’erreur du système à celui d’un humain sur de nombreux cas, pas une erreur marquante à aucune.',
      prompt: 'Ta dernière réponse contient une erreur. Avant de décider si je continue à t’utiliser pour ça, dis-moi quels types de cas tu rates le plus souvent ici, et comment je pourrais les repérer.',
    },
    'eliza-effect': {
      name: 'Effet ELIZA',
      description:
      ...
      counter: 'Profitez de l’aisance, mais demandez-vous ce que le système peut réellement vérifier ou faire : paraître attentionné n’est pas se soucier de vous.',
      prompt: 'Sois franc avec moi : qu’as-tu réellement fait pour produire cette réponse, et qu’est-ce que tu ne peux ni savoir ni vérifier sur ma situation ?',
    },
    'cognitive-offloading': {
      ...
      counter: 'De temps en temps, faites la tâche vous-même d’abord, puis comparez avec la machine. Gardez la compétence nécessaire pour la vérifier.',
      prompt: 'Ne me donne pas encore la réponse. Demande-moi d’abord ce que j’en pense, montre-moi ensuite où mon raisonnement déraille, et seulement après, propose ta version.',
    },
    'competence-misattribution': {
      ...
      counter: 'Demandez-vous ce que vous auriez pu produire sans le modèle, et attribuez-lui honnêtement le reste.',
      prompt: 'Regarde ce qu’on vient de faire ensemble. Liste les parties qui viennent de moi et celles qui viennent de toi, et dis-moi ce que je dois travailler pour faire l’essentiel sans toi.',
    },
    ...
    sycophancy: {
      ...
      counter: 'Ne révélez pas la réponse que vous espérez. Demandez les meilleurs arguments contre votre idée, et voyez un accord soudain comme un signal d’alarme.',
      prompt: 'Voici mon plan. Ne me dis pas ce que tu crois que j’ai envie d’entendre. Donne-moi les trois raisons les plus solides pour lesquelles il pourrait échouer, et dis-le clairement si tu penses que c’est une mauvaise idée.',
    },
    'self-preference-bias': {
      ...
      counter: 'Ne laissez pas un modèle juger son propre travail. Faites appel à un autre modèle, à une personne ou à un test dont la bonne réponse est connue.',
      prompt: 'Je vais te montrer deux textes. N’essaie pas de deviner qui les a écrits. Note chacun uniquement selon ces critères, en citant le passage qui justifie chaque note.',
    },
    'verbosity-bias': {
      ...
      counter: 'Pour comparer des réponses, ramenez-les à la même longueur ou jugez-les selon une liste de critères, pour que les mots en trop ne suffisent pas à gagner.',
      prompt: 'Compare ces deux réponses uniquement sur leur exactitude et leur exhaustivité. La longueur n’est pas un mérite : si la plus courte dit la même chose, préfère-la.',
    },
    'position-bias': {
      ...
      counter: 'Posez la question deux fois en inversant l’ordre. Si le verdict suit l’ordre, ce n’était pas un verdict.',
      prompt: 'Évalue d’abord chaque option séparément, avec une note et une justification, avant de les comparer. L’ordre dans lequel je les ai listées ne veut rien dire.',
    },
    ...
    'feedback-loop-amplification': {
      ...
      counter: 'Remarquez quand la réponse d’un modèle n’est que votre propre avis, dit plus fort. Cherchez des sources que le modèle n’a pas façonnées.',
      prompt: 'Je pense que ce qui suit est vrai. Avant d’être d’accord, donne-moi les meilleurs arguments contre, et dis-moi quel degré de confiance je devrais avoir si on retire ma propre formulation.',
    },
    'model-collapse': {
      ...
      counter: 'Gardez des données originales, faites par des humains, dans la boucle, et signalez ce qui a été généré pour ne pas le confondre avec le réel.',
      prompt: 'Réponds à partir des sources originales quand c’est possible, et dis-moi quelles parties de ta réponse relèvent de schémas courants plutôt que de quelque chose dont tu peux citer la source.',
    },
    'algorithmic-lock-in': {
      ...
      counter: 'Quand toutes les réponses viennent du même modèle, cherchez-en une qui n’en vient pas : une autre source, une autre personne, un autre modèle.',
      prompt: 'Donne-moi la réponse standard, puis deux alternatives sérieuses que des experts défendent réellement, et ce qui devrait être vrai pour que chacune ait raison.',
    },
    'machine-groupthink': {
      ...
      counter: 'Ne prenez pas l’accord entre agents pour une preuve. Prévoyez au moins une vérification indépendante : un test, une source, une personne.',
      prompt: 'Un autre modèle a relu ça et était d’accord. Ignore-le. Vérifie de façon indépendante, et cite un test ou une source extérieure à nous deux qui trancherait la question.',
    },
  },
};
