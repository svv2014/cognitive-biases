export default {
  ...
  ui: {
    ...
    homeEyebrow: '{count} sesgos · seis idiomas',
    homeTitle: 'Atrapa a tu mente — y a tu máquina — con las manos en la masa.',
    homeLead: 'Los sesgos son fáciles de ver en los demás y casi invisibles en uno mismo. Empieza por lo que estás haciendo y mira cuáles andan cerca.',
    homeBrowse: 'Ver los {count}',
    situationsTitle: '¿Qué estás haciendo ahora mismo?',
    situationsLead: 'Elige un momento. Estos son los sesgos que probablemente te acompañan.',
    situationsAll: 'Todos los sesgos de este ámbito',
    sitMoney: 'Gastar o invertir',
    sitMoneyHint: 'Un precio, una oferta, una apuesta que no puedes dejar.',
    sitJudging: 'Juzgar a alguien',
    sitJudgingHint: 'Un colega, un desconocido, un candidato al otro lado de la mesa.',
    sitArguing: 'Discutir sobre noticias',
    sitArguingHint: 'Cuando tienes razón y los demás simplemente no lo ven.',
    sitLearning: 'Aprender algo nuevo',
    sitLearningHint: 'El primer artículo, el primer curso, el primer «ya lo entiendo».',
    sitRemembering: 'Recordar',
    sitRememberingHint: 'La historia que cuentas sobre cómo pasó.',
    sitAi: 'Trabajar con IA',
    sitAiHint: 'Preguntar, confiar, delegar — y los hábitos del propio modelo.',
    dailyTitle: 'Sesgo del día',
    dailyLead: 'Hoy es el mismo para todos. Intenta pillarlo antes de la noche.',
    readMore: 'Leer más',
    twinsTitle: 'Tú y la máquina',
    twinsLead: 'Los modelos aprendieron de nosotros y heredaron nuestros hábitos. Cada sesgo de la era de la IA rima con uno humano más antiguo.',
    twinsHuman: 'El original humano',
    twinsMachine: 'Su eco en la era de la IA',
    quizBlockTitle: '¿Cuáles son los tuyos?',
    quizBlockLead: 'Ocho situaciones rápidas, sin respuestas correctas, unos dos minutos. Elige un conjunto.',
    backToAll: 'Todos los sesgos',
    relatedTitle: 'Suelen aparecer juntos',
    echo: 'Eco en la era de la IA',
    pagerLabel: 'Más sesgos',
    previous: 'Anterior',
    next: 'Siguiente',
    notFoundTitle: 'No hay ningún sesgo con ese nombre',
    notFoundHint: 'Puede que haya cambiado de nombre. El diccionario los tiene todos.',
    promptLabel: 'Pega esto en el chat',
    copy: 'Copiar',
    copied: 'Copiado',
    promptsTitle: 'Que la máquina sea honesta',
    promptsLead: 'Instrucciones para pegar antes de fiarte de una respuesta. Cada sesgo de la era de la IA tiene la suya; estas son las tres que más usarás.',
    promptsAll: 'Los doce sesgos de la era de la IA',
    mapHuman: 'La mente humana',
    mapMachine: 'La era de la IA',
    mapHint: 'Arrastra para girar · toca un punto para abrirlo',
    navPlay: 'Jugar',
    share: 'Compartir',
    shareCopied: 'Enlace copiado',
    shareImage: 'Guardar imagen',
    shareBroken: 'Este enlace está incompleto.',
    shareReceived: 'Alguien ha compartido esto contigo',
    shareGameLead: 'sesgos cognitivos detectados en diez momentos cotidianos.',
    shareBeat: '¿Puedes superarlo?',
    shareFindYours: 'Descubre los tuyos',
    shareGameText: 'Mi resultado: {score} de {total} sesgos cognitivos. ¿Puedes superarlo?',
    shareGameLine: 'sesgos cognitivos detectados. ¿Puedes superarlo?',
    shareQuizText: 'Mis puntos ciegos: {names}. ¿Cuáles son los tuyos?',
    shareQuizNone: 'En el test esquivé los {total} sesgos. ¿O no?',
    shareTheirs: 'Sus puntos ciegos',
    shareTheirsNone: 'Ninguno, dicen. Lo cual ya dice algo sobre el punto ciego del sesgo.',
    openApp: 'Explorar de forma interactiva',
  },
  ...
  demos: {
    scenes: {
      legend: {
        ...
        oneView: 'Una opinión',
        otherView: 'La otra',
        holes: 'Agujeros de bala',
        lost: 'Nunca volvieron',
        anchor: 'Número mostrado primero',
        truth: 'Longitud real',
        mean: 'Estimación media',
      },
      title: 'Cómo funciona',
      simulated: 'Simulación',
      play: 'Reproducir',
      intro: 'Mira cómo se desarrolla.',
      modelCollapse: {
        gen: 'Generación {n}: cada modelo se entrena solo con lo que escribió el anterior. La curva gris es el punto de partida.',
        end: 'Lo raro y lo extraño ha desaparecido. Solo queda la media.',
      },
      feedback: {
        start: 'La gente se inclina ligeramente hacia un lado: {share}%.',
        model: 'Pasada {n}: el modelo acentúa la inclinación — {share}%.',
        people: 'Pasada {n}: la gente asimila la versión acentuada y la devuelve — {share}%.',
      },
      survivorship: {
        returned: 'Agujeros de bala en los bombarderos que volvieron. El instinto: blindar estas zonas.',
        lost: 'Pero los aviones alcanzados aquí nunca volvieron. El blindaje va donde no hay agujeros.',
      },
      anchoring: {
        round: 'Tras ver primero {anchor} km, la gente calcula de media {mean} km. La longitud real es {truth} km.',
      },
    },
    kicker: 'Antes de leer nada, prueba esto',
    another: 'Probar otro',
    readAbout: 'Leer sobre: {name}',
    show: 'Ver',
    anchoring: {
      q1: '¿El Nilo mide más o menos de {anchor} km?',
      longer: 'Más',
      shorter: 'Menos',
      q2: 'Ahora tu mejor estimación: ¿cuánto mide el Nilo?',
      unit: 'km',
      reveal: 'El Nilo mide unos {truth} km. Tu respuesta: {guess}.',
      markAnchor: 'Nuestro número',
      markTruth: 'Longitud real',
      markYou: 'Tú',
      explain: 'El {anchor} de la primera pregunta se eligió al azar: la mitad de los visitantes ve {low} y la otra mitad {high}. Aun así, atrae las respuestas: en los experimentos, quienes ven el número más alto dan cifras claramente más altas, incluso sabiendo que no significa nada.',
    },
    framing: {
      setup: 'Se espera que una nueva enfermedad afecte a 600 personas. Tienes que elegir entre dos programas. ¿Cuál?',
      gainA: 'Programa A: se salvarán 200 personas.',
      gainB: 'Programa B: una probabilidad entre tres de salvar a las 600, y dos entre tres de no salvar a nadie.',
      lossA: 'Programa A: morirán 400 personas.',
      lossB: 'Programa B: una probabilidad entre tres de que no muera nadie, y dos entre tres de que mueran las 600.',
      youSure: 'Elegiste la opción segura.',
      youGamble: 'Elegiste arriesgar.',
      reveal: 'A otros visitantes se les planteó la misma elección así:',
      explain: 'Las dos versiones describen exactamente los mismos resultados. En el estudio original, el 72% eligió la opción segura cuando se hablaba de vidas salvadas, y solo el 22% cuando se hablaba de muertes (Tversky y Kahneman, 1981).',
    },
    forer: {
      q: 'Elige tu mes de nacimiento y describiremos tu personalidad.',
      reading: [
        'Necesitas que los demás te aprecien y te respeten.',
        'Tiendes a exigirte demasiado.',
        'Tienes muchas capacidades que aún no has aprovechado.',
        'A veces dudas seriamente de si tomaste la decisión correcta.',
        'Piensas por ti mismo y no aceptas lo que dicen otros sin pruebas.',
      ],
      rate: '¿Hasta qué punto te describe?',
      low: 'Nada',
      high: 'Totalmente',
      reveal: 'Le diste un {rating} de 5. Todo el mundo recibe exactamente este texto, elija el mes que elija.',
      explain: 'En 1949 el psicólogo Bertram Forer dio a sus alumnos un perfil «personal» sacado de un libro de horóscopos. Todos recibieron el mismo, y de media valoraron su precisión con un 4,3 sobre 5.',
    },
  },

  game: {
    eyebrow: 'Un juego · {count} rondas',
    title: 'Detecta el sesgo',
    lead: 'Diez momentos cotidianos. Nombra el sesgo que se esconde en cada uno y descubre qué hacer con él.',
    start: 'Empezar',
    progress: 'Ronda {n} de {total}',
    score: '{score} / {total}',
    question: '¿Qué sesgo es este?',
    right: 'Correcto.',
    wrong: 'No exactamente: es {name}.',
    next: 'Siguiente',
    finish: 'Ver resultados',
    resultEyebrow: 'Tu puntuación',
    verdict10: 'Todos y cada uno. Ahora intenta pillarlos en ti: esa es la parte difícil.',
    verdict8: 'Buen ojo. Los que se escaparon están abajo.',
    verdict5: 'Nada mal. Los sesgos son más fáciles de nombrar en el papel que en el momento.',
    verdict0: 'Son escurridizos. Repasa los que se te escaparon y vuelve a intentarlo.',
    missedTitle: 'Merecen otra mirada',
  ...
  biases: {
    'fundamental-attribution-error': {
      ...
      counter: 'Antes de culpar al carácter de alguien, piensa en algo de su situación que pueda explicarlo, como harías contigo.',
    },
    'self-serving-bias': {
      ...
      counter: 'De tu último éxito, anota qué te ayudó; de tu último fracaso, qué podrías haber hecho de otra manera.',
    },
    'in-group-favoritism': {
      ...
      counter: 'Imagina la misma petición viniendo de alguien de fuera de tu grupo. Si tu respuesta cambia, decide el grupo, no tú.',
    },
    'bandwagon-effect': {
      ...
      counter: 'Pregúntate qué pensarías de la idea si nadie la hubiera adoptado todavía.',
    },
    groupthink: {
      ...
      counter: 'Encarga a una persona que argumente contra el plan, y pide objeciones antes de decidir, no después.',
    },
    'halo-effect': {
      name: 'Efecto halo',
      description:
      ...
      counter: 'Juzga cada rasgo por separado: valora el trabajo antes de conocer a la persona, o a la persona antes de ver su CV.',
    },
    'moral-luck': {
      name: 'Suerte moral',
      description:
      ...
      counter: 'Juzga la decisión por lo que se sabía al tomarla, no por cómo salió por casualidad.',
    },
    'false-consensus': {
      name: 'Falso consenso',
      ...
      counter: 'Antes de dar por hecho que la gente piensa como tú, pregunta a unos cuantos, sobre todo a quienes no se te parecen.',
    },
    'curse-of-knowledge': {
      ...
      counter: 'Explícaselo a alguien que no conozca el tema y fíjate dónde se pierde: ahí empieza tu explicación.',
    },
    'spotlight-effect': {
      name: 'Efecto foco',
      ...
      counter: 'Recuerda lo poco que te fijaste en los demás en la última reunión. Ellos se fijan en ti más o menos lo mismo.',
    },
    'availability-heuristic': {
      ...
      counter: 'Cuando algo te parezca probable, busca la frecuencia real y no el ejemplo más llamativo.',
    },
    'defensive-attribution': {
      ...
      counter: 'Fíjate si culpas menos a alguien porque se te parece. Aplica el mismo criterio a quien no se te parece.',
    },
    'just-world-hypothesis': {
      ...
      counter: 'Cuando a alguien le va mal, pregúntate qué tendría que ser cierto para que fuera mala suerte, y compruébalo.',
    },
    'naive-realism': {
      ...
      counter: 'Da por hecho que quienes discrepan ven algo que tú no, e intenta resumir su postura tan bien que den tu resumen por bueno.',
    },
    'naive-cynicism': {
      ...
      counter: 'Antes de suponer un motivo egoísta, piensa en una razón generosa por la que alguien habría actuado igual.',
    },
    'forer-effect': {
      ...
      counter: 'Pregúntate si la descripción encajaría con casi cualquiera que conoces. Si es así, no dice nada de ti.',
    },
    'dunning-kruger-effect': {
      ...
      counter: 'Antes de darlo por sabido, pregúntate qué preguntaría a continuación un experto del campo, y si sabrías responder.',
    },
    anchoring: {
      name: 'Anclaje',
      ...
      counter: 'Haz tu propia estimación antes de ver la primera cifra, o plantéate a propósito un punto de partida muy distinto.',
    },
    'automation-bias': {
      ...
      counter: 'Decide de antemano qué resultados revisarás a mano, y revísalos aunque el sistema lleve semanas acertando.',
    },
    'google-effect': {
      ...
      counter: 'Si lo vas a necesitar sin conexión, o para juzgar una respuesta, tómate el tiempo de aprenderlo, no solo de buscarlo.',
    },
    reactance: {
      name: 'Reactancia',
      ...
      counter: 'Cuando sientas el impulso de hacer lo contrario, pregúntate si lo elegirías si nadie te hubiera dicho nada.',
    },
    'confirmation-bias': {
      ...
      counter: 'Busca la prueba más sólida contra lo que crees, y decide de antemano qué te haría cambiar de opinión.',
    },
    'backfire-effect': {
      ...
      counter: 'Cuando una corrección escuece, separa «esto es incómodo» de «esto es falso» antes de responder.',
    },
    'third-person-effect': {
      ...
      counter: 'Da por hecho que los anuncios, titulares y redes sociales que influyen en otros también influyen en ti, y mira de dónde salió tu última opinión.',
    },
    'belief-bias': {
      ...
      counter: 'Prueba el argumento con una conclusión que no te guste. Si la misma lógica te convencería ahí, estás juzgando la lógica.',
    },
    'availability-cascade': {
      ...
      counter: 'Cuenta las fuentes independientes, no las veces que lo has oído.',
    },
    declinism: {
      name: 'Declinismo',
      description:
      ...
      counter: 'Compara el pasado con datos, no con recuerdos: la nostalgia borra los días malos.',
    },
    'status-quo-bias': {
      ...
      counter: 'Imagina que empiezas hoy desde cero. ¿Elegirías lo que tienes ahora?',
    },
    'sunk-cost-fallacy': {
      ...
      counter: 'Pregúntate solo esto: sabiendo lo que sé ahora, ¿empezaría hoy? Lo ya gastado está gastado en cualquier caso.',
    },
    'gamblers-fallacy': {
      ...
      counter: 'Recuerda que los dados, las monedas y la ruleta no tienen memoria. Cada intento empieza de cero.',
    },
    'zero-risk-bias': {
      ...
      counter: 'Compara cuánto riesgo total elimina cada opción, no cuál hace desaparecer un riesgo concreto.',
    },
    'framing-effect': {
      name: 'Efecto marco',
      description:
      ...
      counter: 'Plantea la elección al revés (pérdidas como ganancias, porcentajes como cifras) y mira si tu respuesta se mantiene.',
    },
    stereotyping: {
      ...
      counter: 'Pregúntate qué sabes de verdad de esta persona, y no qué supones de su grupo.',
    },
    'outgroup-homogeneity-bias': {
      ...
      counter: 'Nombra tres formas en que los miembros del otro grupo se diferencian entre sí.',
    },
    'authority-bias': {
      ...
      counter: 'Pregúntate si la afirmación te convencería sin el título de quien la hace, y si el experto habla de su propio campo.',
    },
    'placebo-effect': {
      name: 'Efecto placebo',
      ...
      counter: 'Para saber si algo funciona, busca comparaciones con un placebo, no solo historias de gente que se sintió mejor.',
    },
    'survivorship-bias': {
      ...
      counter: 'Pregunta dónde están los fracasos. Por cada historia de éxito, busca a quienes hicieron lo mismo y no lo lograron.',
    },
    tachypsychia: {
      name: 'Taquipsiquia',
      ...
      counter: 'Tras un momento de estrés, anota pronto la secuencia de hechos y contrástala con relojes, registros o testigos antes de fiarte.',
    },
    'law-of-triviality': {
      ...
      counter: 'Dedica a cada punto un tiempo proporcional a lo que está en juego, y pon el más difícil el primero del orden del día.',
    },
    'zeigarnik-effect': {
      ...
      counter: 'Apunta las tareas pendientes con un siguiente paso, para que tu mente deje de darles vueltas.',
    },
    'ikea-effect': {
      name: 'Efecto IKEA',
      ...
      counter: 'Pide a alguien que no haya participado que juzgue tu trabajo, y compáralo con lo que podrías haber comprado o pedido prestado.',
    },
    'ben-franklin-effect': {
      ...
      counter: 'Fíjate si alguien te cae bien porque le ayudaste. Úsalo con buena intención: pedir un pequeño favor crea buena voluntad.',
    },
    'bystander-effect': {
      ...
      counter: 'Si algo va mal, da por hecho que nadie más ha actuado. Si necesitas ayuda, señala a una persona y pídesela directamente.',
    },
    suggestibility: {
      ...
      counter: 'Haz preguntas abiertas («¿qué pasó?») y no preguntas que llevan la respuesta, y desconfía de los detalles que llegaron con la pregunta.',
    },
    'false-memory': {
      name: 'Falso recuerdo',
      ...
      counter: 'Trata los recuerdos muy nítidos como afirmaciones que hay que comprobar. Busca notas, fotos o mensajes de aquel momento.',
    },
    cryptomnesia: {
      name: 'Criptomnesia',
      ...
      counter: 'Antes de presentar una idea como original, búscala, y apunta de dónde salen tus ideas.',
    },
    'clustering-illusion': {
      ...
      counter: 'Antes de fiarte de un patrón, pregúntate con qué frecuencia el puro azar produciría algo parecido.',
    },
    'pessimism-bias': {
      ...
      counter: 'Anota el resultado probable, no solo el peor, y comprueba después cuántas veces ocurrió de verdad lo peor.',
    },
    'optimism-bias': {
      ...
      counter: 'Planifica según lo que tardaron de verdad proyectos parecidos, no según lo que te parece que debería tardar este.',
    },
    'blind-spot-bias': {
      ...
      counter: 'Da por hecho que tienes los sesgos que ves en los demás. Pide a alguien de confianza que te señale uno.',
    },
    ...
    'algorithm-aversion': {
      ...
      counter: 'Compara la tasa de error del sistema con la de una persona en muchos casos, no un fallo memorable con ninguno.',
      prompt: 'Tu última respuesta tiene un error. Antes de decidir si sigo usándote para esto, dime en qué tipo de casos te equivocas más a menudo aquí y cómo podría detectarlos.',
    },
    'eliza-effect': {
      name: 'Efecto ELIZA',
      description:
      ...
      counter: 'Disfruta de la fluidez, pero pregúntate qué puede comprobar o hacer el sistema de verdad: sonar atento no es preocuparse.',
      prompt: 'Sé claro conmigo: ¿qué hiciste realmente para llegar a esa respuesta y qué no puedes saber ni comprobar sobre mi situación?',
    },
    'cognitive-offloading': {
      ...
      counter: 'De vez en cuando, haz tú la tarea primero y luego compárala con la de la máquina. Conserva la habilidad que necesitas para revisarla.',
      prompt: 'No me des la respuesta todavía. Primero pregúntame qué pienso yo, luego señala dónde falla mi razonamiento y solo entonces muéstrame tu versión.',
    },
    'competence-misattribution': {
      ...
      counter: 'Pregúntate qué habrías hecho sin el modelo, y atribuye el resto con honestidad.',
      prompt: 'Mira lo que acabamos de hacer juntos. Enumera qué partes salieron de mí y cuáles de ti, y dime qué debería practicar para hacer la parte principal sin ti.',
    },
    ...
    sycophancy: {
      ...
      counter: 'No reveles la respuesta que esperas. Pide los mejores argumentos contra tu idea, y toma un acuerdo repentino como señal de alarma.',
      prompt: 'Este es mi plan. No me digas lo que crees que quiero oír. Dame las tres razones más sólidas por las que podría fracasar y dime claramente si te parece una mala idea.',
    },
    'self-preference-bias': {
      ...
      counter: 'No dejes que un modelo juzgue su propio trabajo. Usa otro modelo, una persona o una prueba con respuesta correcta conocida.',
      prompt: 'Te voy a mostrar dos textos. No intentes adivinar quién los escribió. Puntúa cada uno solo según estos criterios y cita el fragmento que justifica cada puntuación.',
    },
    'verbosity-bias': {
      ...
      counter: 'Al comparar respuestas, recórtalas a la misma longitud o evalúalas con una lista de criterios, para que las palabras de más no ganen por sí solas.',
      prompt: 'Compara estas dos respuestas solo por su corrección y su exhaustividad. La extensión no es un mérito: si la más corta dice lo mismo, prefiérela.',
    },
    'position-bias': {
      ...
      counter: 'Pregunta dos veces cambiando el orden. Si el veredicto sigue al orden, nunca fue un veredicto.',
      prompt: 'Evalúa primero cada opción por separado, con una puntuación y un motivo, antes de compararlas. El orden en que las he puesto no significa nada.',
    },
    ...
    'feedback-loop-amplification': {
      ...
      counter: 'Fíjate cuando la respuesta de un modelo es solo tu propia opinión, dicha más alto. Busca fuentes que el modelo no haya moldeado.',
      prompt: 'Creo que lo siguiente es cierto. Antes de darme la razón, dame las mejores pruebas en contra y dime qué grado de confianza debería tener si quito mi propio enfoque.',
    },
    'model-collapse': {
      ...
      counter: 'Mantén en el circuito datos originales hechos por personas, y etiqueta lo generado para que no se confunda con lo auténtico.',
      prompt: 'Responde a partir de fuentes originales cuando puedas y dime qué partes de tu respuesta son patrones comunes y no algo para lo que puedas señalar una fuente.',
    },
    'algorithmic-lock-in': {
      ...
      counter: 'Cuando la respuesta de todos sale del mismo modelo, busca una que no: otra fuente, otra persona, otro modelo.',
      prompt: 'Dame la respuesta estándar y luego dos alternativas serias que los expertos defienden de verdad, y qué tendría que ser cierto para que cada una fuera la correcta.',
    },
    'machine-groupthink': {
      ...
      counter: 'No tomes el acuerdo entre agentes como prueba. Ten al menos una comprobación independiente: un test, una fuente, una persona.',
      prompt: 'Otro modelo revisó esto y estuvo de acuerdo. Ignóralo. Compruébalo de forma independiente y nombra una prueba o una fuente ajena a los dos que lo zanje.',
    },
  },
};
